...
<html dir="ltr" lang="en-US">
  <head>
    ...
    <title>Find Location - {{config('app.name')}}Logistics Cargo HTML5 Template</title>
          ...
          <div class="container"><a class="navbar-brand" href="index.html"><img class="logo logo-light" src="assets/images/logo/logo-light.png" alt="{{config('app.name')}}Logo"/><img class="logo logo-dark" src="assets/images/logo/logo-dark.png" alt="{{config('app.name')}}Logo"/></a>
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                            <ul class="navbar-nav ml-auto">
                              ...
                              <li class="nav-item has-dropdown active"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span>features</span></a>
                                              <ul class="dropdown-menu">
                                                ...
                                                <li class="nav-item current"><a href="find-location.html"><span>find a location</span></a></li>
