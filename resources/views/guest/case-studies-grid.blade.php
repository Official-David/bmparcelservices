...
<html dir="ltr" lang="en-US">
  <head>
    ...
    <title>Case Studies - {{config('app.name')}}Logistics Cargo HTML5 Template</title>
  ...
  <body>
    ...
    <div class="wrapper clearfix" id="wrapperParallax">
                            ...
                            <ul class="navbar-nav ml-auto">
                              ...
                              <li class="nav-item has-dropdown active"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span>news &amp; media</span></a>
                                              <ul class="dropdown-menu">
                                                ...
                                                <li class="nav-item current"><a href="case-studies-grid.html"><span>case studies grid</span></a></li>
      ...
      ============================
      -->
      <section class="cases-grid" id="workStandard">
        <div class="container">
          <div class="row">
            <!-- .cases-filter-->
          ...
          <div class="row" id="all-cases">
            ...
            <div class="case-item col-sm-6 col-md-6 col-lg-4  filter-Optimization filter-Warehousing">
              <div class="case-item-warp">
            ...
            <div class="case-item col-sm-6 col-md-6 col-lg-4 filter-Print filter-Logistics">
              <div class="case-item-warp">
            ...
            <div class="case-item col-sm-6 col-md-6 col-lg-4 filter-Warehousing">
              <div class="case-item-warp">
            ...
            <div class="case-item col-sm-6 col-md-6 col-lg-4 filter-Optimization">
              <div class="case-item-warp">
