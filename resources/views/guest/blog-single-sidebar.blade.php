...
<html dir="ltr" lang="en-US">
  <head>
    ...
    <title>New Additions to our great Metro trucks Fleet - {{config('app.name')}}Logistics Cargo HTML5 Template</title>
          ...
          <div class="container"><a class="navbar-brand" href="index.html"><img class="logo logo-light" src="assets/images/logo/logo-light.png" alt="{{config('app.name')}}Logo"/><img class="logo logo-dark" src="assets/images/logo/logo-dark.png" alt="{{config('app.name')}}Logo"/></a>
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                            <ul class="navbar-nav ml-auto">
                              <li class="nav-item has-dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span>Home</span></a>
                              ...
                              <li class="nav-item has-dropdown active"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span>news &amp; media</span></a>
                                              <ul class="dropdown-menu">
                                                <li class="nav-item"><a href="blog-grid-fullwidth.html"><span>our blog</span></a></li>
                                                <li class="nav-item current"><a href="blog-single-sidebar.html"><span>single blog post</span></a></li>
            ...
            <div class="col-12 col-lg-6 offset-lg-3">
              <div class="title text-center">
                <ol class="breadcrumb d-flex">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">New Additions to our great Metro trucks Fleet</li>
                </ol>
            ...
            <div class="col-sm-12 col-md-12 col-lg-4 order-2 order-lg-0">
              <div class="sidebar sidebar-blog">
                ...
                <div class="widget widget-recent-posts">
                  ...
                  <div class="widget-content">
                    <div class="carousel owl-carousel carousel-dots" data-slide="1" data-slide-rs="1" data-autoplay="true" data-nav="false" data-dots="true" data-space="0" data-loop="true" data-speed="800">
                      <div class="entry">
                        <div class="entry-img"><a href="javascript:void(0)"><img src="assets/images/blog/sidebar/post-1.jpg" alt="title"/></a></div>
                        <div class="entry-desc">
                          <div class="entry-meta"><a href="javascript:void(0)">warhouse</a><a href="javascript:void(0)">construction</a></div>
                          <div class="entry-title"><a href="https://demo.zytheme.com/equita/blog-single.html">Cargo flow through better supply chain visibility</a></div>
                        </div>
                      </div>
                      <!-- .entry end-->
                      <div class="entry">
                        <div class="entry-img"><a href="javascript:void(0)"><img src="assets/images/blog/sidebar/post-2.jpg" alt="title"/></a></div>
                        <div class="entry-desc">
                          <div class="entry-meta"><a href="javascript:void(0)">warhouse</a><a href="javascript:void(0)">construction</a></div>
                          <div class="entry-title"><a href="https://demo.zytheme.com/equita/blog-single.html">New Additions To Our Great Metro Trucks</a></div>
                        </div>
                      </div>
                      <!-- .entry end-->
                    </div>
                ...
                <div class="widget widget-tags pb-30">
                  ...
                  <div class="widget-content"><a href="javascript:void(0)">Responsive</a><a href="javascript:void(0)">Modern</a><a href="javascript:void(0)">Corporate</a><a href="javascript:void(0)">Business</a><a href="javascript:void(0)">Fresh</a><a href="javascript:void(0)">Awesome</a></div>
                </div>
                <!-- .widget-tags end-->
              </div>
            </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-8">
              ...
              <div class="blog-entry">
                <div class="entry-meta-container">
                  <div class="entry-category"><a href="javascript:void(0)">business</a><a href="javascript:void(0)">vacations</a></div>
                  <div class="entry-author"><span>by: <i>mike dooley</i></span></div>
                ...
                <div class="entry-content clearfix">
                  ...
                  <div class="entry-img"><a href="javascript:void(0)"><img src="assets/images/blog/standard/1.jpg" alt="entry image"/></a></div>
                  <div class="entry-bio"> 
                  ...
                  <div class="entry-container">
                    <div class="entry-share"><a href="javascript:void(0)"><i class="fab fa-facebook-f"></i><span class="share-title">share on facebook</span></a><a href="javascript:void(0)"><i class="fab fa-twitter"> </i><span class="share-title">share on twitter</span></a><a href="javascript:void(0)"><i class="fab fa-linkedin-in"></i><span class="share-title">share on linkedin</span></a></div>
                    <!-- .entry-share end-->
                    <div class="entry-tags"><span>tags:</span><a href="javascript:void(0)">warehouse</a><a href="javascript:void(0)">cargo</a><a href="javascript:void(0)">industry</a><a href="javascript:void(0)">construction</a><a href="javascript:void(0)">transport</a></div>
                    <!-- .entry-tags end-->
                  </div>
                  <div class="nav-posts">
                    <div class="prev-post"><img src="assets/images/blog/thumb/prev.jpg" alt="title"/>
                      <div class="post-body"><span>previous </span><a class="post-link" href="javascript:void(0)">Importers achieve cost savings through the First Sale rule!</a></div>
                    </div>
                    <div class="next-post">
                      <div class="post-body"><span>next </span><a class="post-link" href="javascript:void(0)">Cargo flow through better supply chain visibility, control.</a></div><img src="assets/images/blog/thumb/next.jpg" alt="title"/>
                    </div>
                  </div>
                  <div class="entry-widget-bio clearfix">
                    <div class="entry-widget-content"><img src="assets/images/blog/author/2.jpg" alt="author"/>
                      <div class="entry-bio-desc">
                        ...
                        <p>Founded by Begha over many cups of tea at her kitchen table in 2009, our brand promise is simple: to provide powerful digital marketing solutions to small and medium businesses.</p><a href="javascript:void(0)"><i class="fab fa-facebook-f"></i></a><a href="javascript:void(0)"><i class="fab fa-twitter"></i></a><a href="javascript:void(0)"><i class="fab fa-vimeo"></i></a><a href="javascript:void(0)"><i class="fab fa-linkedin-in"></i></a>
                      </div>
                    </div>
                  </div>
                  <!-- .entry-bio end-->
                  ...
                  <div class="entry-widget-content">
                    <ul class="comments-list">
                      <li class="comment-body">
                        <div class="avatar"><img src="assets/images/blog/author/3.jpg" alt="avatar"/></div>
                        <div class="comment">
                          <h6>Richard Muldoone</h6>
                          <div class="date">Feb 28, 2019 - 08:07 pm</div>
                          <p>The example about the mattress sizing page you mentioned in the last WBF can be a perfect example of new keywords and content, and broadening the funnel as well. I can only imagine the sale numbers if that was the site of a mattress selling company.</p><a class="reply" href="javascript:void(0)">reply</a>
                          <ul class="replies-list">
                            <li class="comment-body">
                              <div class="avatar"><img src="assets/images/blog/author/4.jpg" alt="avatar"/></div>
                              <div class="comment">
                                <h6>mike dooley</h6>
                  ...
                  <div class="entry-widget-content">
                    <form class="mb-0" id="post-comment">
                      <div class="row">
                        ...
                        <div class="col-12">
                          <button class="btn btn--primary btn--inverse" type="submit">Submit Comment</button>
                        </div>
                      </div>
                    </form>
                  </div>
