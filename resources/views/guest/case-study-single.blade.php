                            ...
                            <ul class="navbar-nav ml-auto">
                              ...
                              <li class="nav-item has-dropdown active"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span>news &amp; media</span></a>
                                              <ul class="dropdown-menu">
                                                ...
                                                <li class="nav-item current"><a href="case-study-single.html"><span>single case study</span></a></li>
                                              </ul>
                              </li>
            ...
            <div class="col-12 col-lg-10 offset-lg-1">
              <div class="title text-center">
                <div class="title-heading">
                  <h1>floride chemicals factory </h1>
                </div>
                <div class="clearfix"></div>
                <ol class="breadcrumb justify-content-center">
                  <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                  <li class="breadcrumb-item"><a href="">case studies</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Floride Chemicals Factory</li>
                </ol>
              </div>
              <!-- End .title -->
            </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-8">
              <div class="case-study-entry">
                <div class="entry-content">
                  ...
                  </div><img class="entry-chart" src="assets/images/chart/Chart-Card.jpg" alt="Chart-Img"/>
