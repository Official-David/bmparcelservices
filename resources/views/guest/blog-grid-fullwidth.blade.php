            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                            <ul class="navbar-nav ml-auto">
                              ...
                              <li class="nav-item has-dropdown active"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span>news &amp; media</span></a>
                                              <ul class="dropdown-menu">
                                                <li class="nav-item current"><a href="blog-grid-fullwidth.html"><span>our blog</span></a></li>
      ...
      <section class="blog blog-grid pb-90" id="blog">
        <div class="container">
          <div class="row">
            ...
            <div class=" col-sm-6 col-md-6 col-lg-4">
              <div class="blog-entry">
                <div class="entry-img"><a href="https://demo.zytheme.com/equita/blog-single.html"><img src="assets/images/blog/grid/4.jpg" alt="Changes to our Trade Credit Policy and Procedures "/></a></div>
                <!-- End .entry-img-->
                <!-- End .entry-date-->
                <div class="entry-content">
                  ...
                  <div class="entry-title">
                    <h4><a href="https://demo.zytheme.com/equita/blog-single.html">Changes to our Trade Credit Policy and Procedures </a></h4>
                  </div>
                  <div class="entry-date"><span class="month">jan 20</span><span class="date">2021</span></div>
                  <div class="entry-bio">
            ...
            <div class=" col-sm-6 col-md-6 col-lg-4">
              <div class="blog-entry">
                <div class="entry-img"><a href="https://demo.zytheme.com/equita/blog-single.html"><img src="assets/images/blog/grid/5.jpg" alt="New Additions to our great Metro trucks Fleet "/></a></div>
                <!-- End .entry-img-->
                <!-- End .entry-date-->
                <div class="entry-content">
                  ...
                  <div class="entry-title">
                    <h4><a href="https://demo.zytheme.com/equita/blog-single.html">New Additions to our great Metro trucks Fleet </a></h4>
                  </div>
                  <div class="entry-date"><span class="month">jan 23</span><span class="date">2021</span></div>
                  <div class="entry-bio">
            ...
            <div class=" col-sm-6 col-md-6 col-lg-4">
              <div class="blog-entry">
                <div class="entry-img"><a href="https://demo.zytheme.com/equita/blog-single.html"><img src="assets/images/blog/grid/6.jpg" alt="The new Driver Training &amp; Recruitment Program "/></a></div>
                <!-- End .entry-img-->
                <!-- End .entry-date-->
                <div class="entry-content">
                  ...
                  <div class="entry-title">
                    <h4><a href="https://demo.zytheme.com/equita/blog-single.html">The new Driver Training &amp; Recruitment Program </a></h4>
                  </div>
                  <div class="entry-date"><span class="month">jan 24</span><span class="date">2021</span></div>
                  <div class="entry-bio">
