...
<html dir="ltr" lang="en-US">
  ...
  <body>
    ...
    <div class="wrapper clearfix" id="wrapperParallax">
            ...
            <div class="block-right">
              <div class="top-contact">
                <div class="contact-infos"><i class="fas fa-phone-alt"></i>
                  <div class="contact-body"> <span>call us:</span><a href="tel:123-456-7890">002 010612457410</a></div>
                </div>
                <div class="contact-infos"><i class="fas fa-envelope"></i>
                  <div class="contact-body"> <span>email us:</span><a href="mailto:Astred@zytheme.com?Subject=Hello%20again">Equita@7oroof.com					</a></div>
                </div>
          ...
          <div class="container">
            <div class="collapse navbar-collapse" id="navbarContent">
                            <ul class="navbar-nav ">
                              <li class="nav-item has-dropdown active"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span>Home</span></a>
                                              <ul class="dropdown-menu">
                                                ...
                                                <li class="nav-item current"><a href="home-modern.html"><span>home modern</span></a></li>
              ...
              <div class="module-container">
                <!-- Start .module-social-->
                <div class="module module-social module-social-2"><a class="share-facebook" href="javascript:void(0)"><i class="fab fa-facebook-f"> </i></a><a class="share-instagram" href="javascript:void(0)"><i class="fab fa-instagram"></i></a><a class="share-twitter" href="javascript:void(0)"><i class="fab fa-twitter"></i></a></div>
                <!-- End .module-social-->
                <!--  Start Module Search  -->
                ...
                <div class="row">
                  <div class="col-12 col-lg-7">
                    <div class="slide-content">
                      ...
                      <div class="slide-buttons"><a class="btn btn--white btn--inverse" href="javascript:void(0)">more about us</a>
                        <div class="video-btn"><a class="popup-video btn-video" href="https://www.youtube.com/watch?v=nrJtHemSPW4"><i class="fas fa-play"></i></a><span>our video!</span></div>
                      </div>
                    </div>
                    <!-- End .slide-content -->
                  </div>
                ...
                <div class="row">
                  <div class="col-12 col-lg-8">
                    <div class="slide-content">
                      ...
                      <div class="slide-buttons"><a class="btn btn--white btn--inverse" href="javascript:void(0)">more about us</a><a class="btn btn--transparent" href="javascript:void(0)">our services</a></div>
                    </div>
                    <!-- End .slide-content -->
                  </div>
                </div>
        ...
        <div class="container"> 
          <div class="features-container">
            <div class="feature-head">
              ...
              <h6>Digital That Saves Your Time!</h6>
            </div>
            <div class="feature-panel"> 
              <h6>transparent pricing </h6>
              <p>International supply chains involves a myriad of unknown risks and challenging.</p><a href="javascript:void(0)"><i class="icon-arrow-right"></i></a>
            </div>
            <div class="feature-panel"> 
              <h6>Real Time Tracking</h6>
              <p>We ensure customers’ supply chains are fully compliant by comprehensive practices.</p><a href="javascript:void(0)"><i class="icon-arrow-right"></i></a>
            </div>
            <div class="feature-panel"> 
              <h6>warehouse storage</h6>
              <p>Depending on product needs and requirements, we provide professional warehouse.</p><a href="javascript:void(0)"><i class="icon-arrow-right"></i></a>
            </div>
          </div>
        </div>
        <!-- End .container-->
      ...
      ============================
      -->
      <section class="cta cta-6 bg-overlay bg-overlay-dark2" id="cta-6">
        <div class="bg-section"><img src="assets/images/cta/1.jpg" alt="background"/></div>
        <div class="row">
          <div class="col-12 col-lg-5">
            <div class="video-btn"><a class="popup-video btn-video btn-video-2" href="https://www.youtube.com/watch?v=nrJtHemSPW4"><i class="fas fa-play"></i></a></div>
            <div class="heading heading-2 heading-light">
              <p class="heading-subtitle">Flexibile, Improved & Accelerated Solutions</p>
              <h2 class="heading-title">No Rigid Services, just solutions!</h2>
            </div>
          </div>
          <!--End .col-lg-6-->
          <div class="col-12 col-lg-7"> 
