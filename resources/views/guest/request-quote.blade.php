              ...
              <div class="quote-form contact-body">
                ...
                <form class="contactForm" method="post" action="https://demo.zytheme.com/equita/assets/php/contact.php">
                  <div class="form-section"> 
                    ...
                    <div class="row"> 
                      <div class="col-12"> 
                        <input class="form-control" type="text" name="contact-company" placeholder="company" required=""/>
                      </div>
                  ...
                  <div class="form-section"> 
                    ...
                    <div class="row"> 
                      <div class="col-12"> 
                        <input class="form-control" type="text" name="contact-street" placeholder="street" required=""/>
                      </div>
                      <div class="col-12 col-lg-4"> 
                        <input class="form-control" type="text" name="contact-country" placeholder="country" required=""/>
                      </div>
                      <div class="col-12 col-lg-4"> 
                        <input class="form-control" type="text" name="contact-city" placeholder="city" required=""/>
                      </div>
                      <div class="col-12 col-lg-4"> 
                        <input class="form-control" type="text" name="contact-zip" placeholder="zip" required=""/>
                      </div>
                      <div class="col-12">
                  ...
                  <div class="form-section"> 
                    ...
                    <div class="row"> 
                      ...
                      <div class="col-12">
                        <div class="custom-radio-group">
                          <div class="custom-control custom-radio custom-control-inline">
                            <input class="custom-control-input" type="radio" id="customRadioInline3" name="customRadioInline2"/>
                            <label for="customRadioInline3">call before delivery</label>
                          </div>
                          <div class="custom-control custom-radio custom-control-inline">
                            <input class="custom-control-input" type="radio" id="customRadioInline4" name="customRadioInline2"/>
                  ...
                  <div class="form-section"> 
                    ...
                    <div class="row"> 
                      ...
                      <div class="col-12 col-lg-4"> 
                        <input class="form-control" type="text" name="contact-weight" placeholder="Total Weight, lbs" required=""/>
                      </div>
                      <div class="col-12 col-lg-4"> 
                        <input class="form-control" type="text" name="contact-quantity" placeholder="QTY" required=""/>
                      </div>
                      <div class="col-12 col-lg-4"> 
                      ...
                      <div class="col-12">
                        <div class="custom-radio-group">
                          <div class="custom-control custom-radio custom-control-inline">
                            <input class="custom-control-input" type="radio" id="customRadioInline7" name="customRadioInline3"/>
                            <label for="customRadioInline7">stackable</label>
                          </div>
                          <div class="custom-control custom-radio custom-control-inline">
                            <input class="custom-control-input" type="radio" id="customRadioInline8" name="customRadioInline3"/>
